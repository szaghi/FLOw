...
are_tests_passed(1) = (p%density  >= 1._R_P - ZeroR_P).and.(p%density  <= 1._R_P + ZeroR_P).and. &
                      (p%velocity >= 0._R_P - ZeroR_P).and.(p%velocity <= 0._R_P + ZeroR_P).and. &
                      (p%pressure >= 1._R_P - ZeroR_P).and.(p%pressure <= 1._R_P + ZeroR_P)
...
are_tests_passed(2) = (u%density  >= 1._R_P  - ZeroR_P).and.(u%density  <= 1._R_P  + ZeroR_P).and. &
                      (u%momentum >= 0._R_P  - ZeroR_P).and.(u%momentum <= 0._R_P  + ZeroR_P).and. &
                      (u%energy   >= 2.5_R_P - ZeroR_P).and.(u%energy   <= 2.5_R_P + ZeroR_P)
