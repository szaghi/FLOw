...
conservative1 = 0.125_R8P
test_passed(1) = (conservative1%density    == 0.125_R8P).and. &
                 (conservative1%momentum%x == 0.125_R8P).and. &
                 (conservative1%momentum%y == 0.125_R8P).and. &
                 (conservative1%momentum%z == 0.125_R8P).and. &
                 (conservative1%energy     == 0.125_R8P)
...
momentum = 1._R8P
conservative1 = conservative_compressible(density=0.125_R8P, momentum=momentum, energy=2._R8P)
