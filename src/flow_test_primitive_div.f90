...
test_passed(3) = primitive3%velocity == (primitive2%velocity / 0.125_R_P)
print "(A)", ''
print "(A,3(F6.3,1X))", 'velocity / density => 2 / 0.125 = ', primitive3%velocity%field
call print_error(test='primitive3%velocity = primitive2%velocity / primitive1%density', is_test_passed=test_passed(3))

primitive3 = primitive1 / 2_I_P
test_passed(4) = primitive3 == (primitive1 / 2_I_P)
print "(A)", ''
...
call print_error(test='primitive3 = primitive1 / 2', is_test_passed=test_passed(4))
...
endprogram flow_test_primitive_div
