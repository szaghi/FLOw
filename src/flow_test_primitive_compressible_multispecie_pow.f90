...
test_passed(2) = primitive2%partial_densities(1) == (0.125_R_P ** 2_I_P)
...
test_passed(3) = primitive2%density == (0.125_R_P ** 2._R_P)
...
test_passed(4) = primitive2%partial_densities(1) == (0.125_R_P ** 2._R_P)
